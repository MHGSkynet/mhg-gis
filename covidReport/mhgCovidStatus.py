...
# Input resources
statusKml			= dataFolder + "/mhgCovidStatus.kml"						# KML generated by mhgCovidFetch with data set for given day
...
#
if USE_GUI:
	statusLayer = iface.addVectorLayer(statusKml, layerTitle, "ogr")
else:
	barfd("DEBUG Create vector layer")
	statusLayer = QgsVectorLayer(statusKml, layerTitle, "ogr")
